...
public class WalkSportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_walk_sport);
    ...
    public void clickStop() {
        mIBStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("sport_name", "walk");
                timer.stop();
                Tools.toastMessageShort(WalkSportActivity.this, "运动结束!");
                mIBStop.setVisibility(View.GONE);
                mIBStart.setVisibility(View.VISIBLE);
                mIBPause.setVisibility(View.GONE);
                Intent intent = new Intent(WalkSportActivity.this, CompleteSportActivity.class);
