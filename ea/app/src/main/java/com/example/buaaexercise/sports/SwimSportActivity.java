...
public class SwimSportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swim_sport);
    ...
    public void clickStop() {
        mIBStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("sport_name", "swim");
                timer.stop();
                Tools.toastMessageShort(SwimSportActivity.this, "运动结束!");
                mIBStop.setVisibility(View.GONE);
                mIBStart.setVisibility(View.VISIBLE);
                mIBPause.setVisibility(View.GONE);
                Intent intent = new Intent(SwimSportActivity.this, CompleteSportActivity.class);
