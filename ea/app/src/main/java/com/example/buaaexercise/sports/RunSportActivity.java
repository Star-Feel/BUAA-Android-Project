...
public class RunSportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_run_sport);
    ...
    public void clickStop() {
        mIBStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("sport_name", "run");
                timer.stop();
                Tools.toastMessageShort(RunSportActivity.this, "运动结束!");
                mIBStop.setVisibility(View.GONE);
                mIBStart.setVisibility(View.VISIBLE);
                mIBPause.setVisibility(View.GONE);
                Intent intent = new Intent(RunSportActivity.this, CompleteSportActivity.class);
